...
import { BestTradeOptions, Pool } from '@vnaysn/jediswap-sdk-v3'
 ...
 * @notice This class is functionally the same as the `Trade` class in the `@vnaysn/jediswap-sdk-v3` package, aside from typing and some input validation.
 * @template TInput The input token, either Ether or an ERC-20
 * @template TOutput The output token, either Ether or an ERC-20
 * @template TTradeType The trade type, either exact input or exact output
 */
